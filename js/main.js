...
function initProjectModals() {
  ...
  const projectData = {
    arm: {
      ...
      inlineImage: { src: 'assets/images/arm-inline-photo.jpg', alt: 'ARM app in action on Cousin Island' },
    ...
    tracking: {
      ...
      inlineImage: { src: 'assets/images/tracking-inline-photo.jpg', alt: 'Tortoise tracking system in the field' },
